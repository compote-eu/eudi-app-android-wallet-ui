...
// Phase 3b: the `DeviceAuthenticationInteractor` contract moved to :shared-ui/commonMain (same
// package). This implementation stays here — it delegates to the Android DeviceAuthenticationController.
