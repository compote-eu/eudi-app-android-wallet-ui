...
[![Jetpack Compose](https://img.shields.io/badge/Jetpack%20Compose-2026.06.00-4285F4.svg?logo=jetpackcompose)](https://developer.android.com/jetpack/compose)
...
This fork carries two independent lines of development — one sharing Kotlin between Android and iOS,
one Android-only — maintained by different mechanisms.
[This document](wiki/BRANCHES.md) says which branch is which, how upstream work is brought in and
recorded, and which verify set applies to each line.
