...
/**
 * `local` flavor Wallet Core configuration.
 *
            ...
            if (_config == null) {
                _config = EudiWalletConfig {
                    ...
                    configureEtsiTrust {
                        ...
                        loteLocations(
                            SupportedLists(
                                ...
                                // wrprcProviders = Uri("https://${BuildConfig.LOCAL_IP}:8446/LOTE/json/WRPRCProviders.jwt"),
                    ...
                    configureIssuerTrust {
                        ...
                        // Follows the *Check Registration Certificates* setting, which is off
                        // by default — so local development is unaffected unless you turn it on.
