 ...
 * disabled is the default — so a caller that consulted this alone would refuse every issuance in a
 * stock build. Callers gate on the config flag first and only then ask this.
 */
