...
class TestProximitySuccessInteractor {
    ...
    private lateinit var interactor: ProximitySuccessInteractor
    ...
    fun before() {
        ...
        interactor = ProximitySuccessInteractorImpl(
    ...
    fun `When constructed without walletCorePresentationController, Then construction does not throw`() {
        // When
        val newInteractor = ProximitySuccessInteractorImpl(
            walletCoreDocumentsController = walletCoreDocumentsController,
            resourceProvider = resourceProvider,
            uuidProvider = uuidProvider,
        )
    ...
    fun `Given Case 5, When getUiItems is called, Then Case 5 Expected Result is returned`() {
        coroutineRule.runTest {
            ...
            interactor.getUiItems().runFlowTest {
                // Then
                val expectedResult = ProximitySuccessInteractorGetUiItemsPartialState.Failed(
